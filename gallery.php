...
<body>
  ...
  <div class="container">
    ...
    <?php
      ...
      $ret="SELECT * FROM tms_vehicle  ORDER BY RAND() LIMIT 25 "; //get all feedbacks
    ...
    <div class="row">
      ...
      <div class="col-md-5">
        ...
        <li class="list-group-item"><?php echo $row->v_name;?></li>
          ...
          <li class="list-group-item"><?php echo $row->v_mileage;?></li>
          <li class="list-group-item"><?php echo $row->v_engine_capacity;?></li>
          <li class="list-group-item"><?php echo $row->v_price;?></li>
        </ul><br>
        <a class="btn btn-success" href="usr/">Buy vehicle
