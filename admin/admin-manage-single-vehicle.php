  ...
  if(isset($_POST['upate_veh']))
    {
            ...
            $query="update tms_vehicle set v_name=?, v_reg_no=?, v_mileage=?, v_price=?, v_category=?, v_dpic=?, v_status=? where v_id = ?";
            $stmt = $mysqli->prepare($query);
            $rc=$stmt->bind_param('ssssssi', $v_name, $v_reg_no, $v_mileage, $v_price, $v_category, $v_dpic, $v_status, $v_id);
            $stmt->execute();
                if($stmt)
                {
        ...
        ?>
          <form method ="POST" enctype="multipart/form-data"> 
            ...
            <div class="form-group">
                ...
                <input type="text" value="<?php echo $row->v_mileage;?>" class="form-control" id="exampleInputEmail1" name="v_mileage">
            </div>
            <div class="form-group">
                <label for="exampleInputEmail1">vehicle Price</label>
                <input type="text" value="<?php echo $row->v_price;?>" class="form-control" id="exampleInputEmail1" name="v_price">
            </div>
