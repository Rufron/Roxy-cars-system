...
CREATE TABLE `tms_vehicle` (
  ...
  `v_engine_capacity` varchar(200) NOT NULL
  `v_price` varchar(200) NOT NULL
  `v_mileage` varchar(200) NOT NULL
...
INSERT INTO `tms_vehicle` (`v_id`, `v_name`, `v_reg_no`, `v_pass_no`, `v_driver`, `v_category`, `v_dpic`, `v_status`, `v_engine_capacity`, `v_price`, `v_mileage`) VALUES
